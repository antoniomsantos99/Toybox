...
#NE/SW
    ...
    if(orientation=='NE' and box[y-1][x+1]!='#'):
        ...
        x-=1
        y+=1
    elif(orientation=='NE' and (box[y][x+1]=='#' or box[y][x+1]=='|')):
        orientation = 'NW'
        box[y][x]=' '
        box[y-1][x-1]='O'
        x-=1
        ...
        x+=1
        y-=1
    elif(orientation=='SW' and (box[y][x-1]=='#' or box[y][x-1]=='|')):
        orientation = 'SE'
        box[y][x]=' '
        box[y][x+1]=' '
        box[y+1][x+1]='O'
    ...
    #NW/SE
        ...
        x+=1
        y+=1
    elif(orientation=='NW' and (box[y][x-1]=='#' or box[y][x-1]=='|')):
        orientation = 'NE'
        box[y][x]=' '
        box[y][x+1]=' '
        box[y-1][x+1]='O'
        ...
        x+=1
        y-=1
    elif(orientation=='SE' and (box[y][x+1]=='#' or box[y][x+1]=='#')):
        orientation = 'SW'
        box[y][x]=' '
        box[y+1][x-1]='O'
        x-=1
